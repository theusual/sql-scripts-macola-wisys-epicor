...
WHERE     ltrim(OH.cus_no) IN ('1575', '20938', '122523','25000', '35000') 
                       AND OH.oe_po_no > '0' 
                       AND OH.ord_type = 'O' 
                       ...
                       /*	Conditions just for Open Order Shipped	- Pull orders shipped in last 40 days from Malvern*/ 
                       AND (CONVERT(varchar, CAST(rtrim(SH.ship_dt) AS datetime), 101) > DATEADD(day, - 40, GETDATE()))
UNION ALL
...
WHERE     ltrim(OH.cus_no) IN ('1575', '20938', '122523','25000', '35000') 
                       ...
                       AND isnumeric(OH.oe_po_no) = 1  
                       AND OH.ship_to_addr_4 LIKE '%,%' 
                       /*	Conditions just for History	- Pull orders shipped in last 40 days from Malvern*/ 
                       AND (CONVERT(varchar, CAST(rtrim(SH.ship_dt) AS datetime), 101) > DATEADD(day, - 40, GETDATE()))
UNION ALL
