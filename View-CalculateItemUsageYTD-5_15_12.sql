--ALTER VIEW Z_IMINVLOC_USAGE_WITH_LEVELS AS 

--Created:	01/10/11	 By:	BG
--Last Updated:	5/15/12	 By:	BG
--Purpose: Calculate usage YTD for items
--Last Change: Fixed bug in calculation of 2nd and 3rd levels, commented out calculations for levels 2-4
